...
public class ClienteDAOTeste {
    ...
    public static void listarCliente(String nome) {
       /* DefaultTableModel modelo = (DefaultTableModel) teste.tblTeste.getModel();
        modelo.setNumRows(0);
        ...
        String sql = "";
        if (nome.equals("")) {
            sql = "SELECT * FROM cliente ORDER BY cli_Nom";
        } else {
            sql = "SELECT * FROM cliente WHERE cli_Nom LIKE '%" + nome.trim() + "%' ORDER BY cli_Nom";
        }
        ...
        if (clienteConect.conecta()) {
            ...
            clienteConect.desconectar();
            JOptionPane.showMessageDialog(null, "Quantidade de clientes: " + cont);
        }*/
    }
    ...
    public static void gravarCliente(Cliente cliente) {
        ...
        if (clienteConect.conecta()) {
            try {
                ...
                ps.setString(4, FormatadorMascara.limpaMasc_Cpf_Cnpj(cliente.getCli_Cpf_Cnpj()).trim());
    ...
    public static void alterarCliente(Cliente cliente) {
        ...
        if (clienteConect.conecta()) {
            try {
                ...
                ps.setString(6, FormatadorMascara.limpaMascTel(cliente.getCli_Tel_Cel()).trim());
    ...
    public static void excluir(int id) {
        String sql = "";
        sql = "DELETE FROM cliente WHERE cli_Cod=?";
